...
<head>
    ...
    <link rel="icon" type="image/png" sizes="200x200" href="{{asset('images/connectedconference.png')}}">
    <link rel="apple-touch-icon" type="image/png" sizes="200x200" href="{{asset('images/connectedconference.png')}}">
    <meta name="csrf-token" content="{{ csrf_token() }}">
    <meta name="title" content="@yield('title', 'Connected Conference - Alert')">
    @yield('seo')
    <title>@yield('title', 'Connected Conference - Alert')</title>
...
<wrapper class="d-flex flex-column">
    <nav class="navbar fixed-top navbar-expand-lg navbar-dark bg-dark">
        <a class="navbar-brand" href="/">
            <img src="{{ asset('images/connectedconference.png') }}" width="30" height="30" class="d-inline-block align-top" alt="Tipz">
